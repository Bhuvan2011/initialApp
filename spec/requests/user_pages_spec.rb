...
describe "User pages" do
  ...
  describe "index" do
    before{
      ...
      FactoryGirl.create(:user, name: "adam", email: "adam@gmail.com")
      visit users_path
    }
  ...
  describe "pofile page" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following the user" do
        before { visit user_path(other_user) }

        it "should increment the followed users count" do
          expect do
            click_button "Follow"
          end.to change(user.follwed_users, :count).by(1)
        end
  ...
  describe "following/follower" do
    ...
    describe "followed user" do
      ...
      it { should have_link(other_ser.name, href: user_path(other_user)) }
    end
